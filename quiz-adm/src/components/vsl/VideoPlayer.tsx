    ...
    return (
      <div className="aspect-video w-full rounded-2xl border border-dashed border-white/20 bg-white/5 flex flex-col items-center justify-center text-center p-6">
        ...
        <p className="text-white/70 text-sm">
          Ajoute ton lien YouTube dans <code className="text-gold-300">src/lib/vsl-config.ts</code>
        </p>
      </div>
    )
  }
    ...
    <div className="relative aspect-video w-full overflow-hidden rounded-2xl bg-black shadow-2xl shadow-black/60 ring-1 ring-white/10">
      {playing ? (
        ...
        >
          ...
          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex h-20 w-20 items-center justify-center rounded-full bg-gold-400 text-forest-950 shadow-xl shadow-gold-500/40 transition-transform group-hover:scale-110">
