...
interface Props {
  step: number; // 2–6 (step 1 is welcome, no bar)
  total: number; // always 6
}

const LABELS = ['Revenus', 'Dépenses fixes', 'Dépenses variables', 'Placements', 'Vos coordonnées'];
  ...
  return (
    <div className="w-full max-w-xl mx-auto mb-8">
      <div className="flex justify-between text-xs text-amber-700 font-semibold mb-2 px-1">
        <span>Étape {step - 1} sur {total - 2}</span>
